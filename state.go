...
func InitState(mongoChInput chan MessCommand, mongoChOutput chan MessAnswer) {
	w_state := State{}
...
func (state *State) StateWorker(mongoChInput chan MessCommand, mongoChOutput chan MessAnswer) {
